...
<div class="grid_24 content">
    <div class="content-wrapper">
        ...
        <?php if (inkthemes_get_option('colorway_home_page_blog_post') != 'off') { ?>
                ...
                <div class=" grid_12 testimonial_div alpha animated fade_left">
                    ...
                    <?php else : ?>			
                        <div class="feature_widget">
                            ...
                            <?php } else { ?>
                                <h2><?php _e('Widgetized Area', 'colorway'); ?></h2>
                            <?php } ?>  
			...
			<embed class="widget_img" src='http://player.youku.com/player.php/sid/XMTQzMDQxNjU3Ng==/v.swf' allowFullScreen='true' quality='high' align='middle' allowScriptAccess='always' type='application/x-shockwave-flash' width='480' height='400'></embed>
                                </div>
                            <?php } ?>
                        </div>
                    <?php endif; ?>	
